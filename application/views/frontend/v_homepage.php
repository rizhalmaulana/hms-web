  <!--/ Intro Skew Star /-->
  <div id="home" class="intro route bg-image" style="background-image: url(<?php echo base_url(); ?>assets_frontend/img/intro-bg.png)">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">BoDygital Master Spot</span><strong class="text-slider"></strong></p>
        </div>
      </div>
    </div>
  </div>
        ...
        <?php foreach($spot as $a){ ?>
          <div class="col-md-4">
            <div class="card card-blog">
              <div class="card-img">
                <a href="<?php echo base_url().$a->spot_slug ?>">
                  <?php if($a->spot_sampul != ""){ ?>
                    <img src="<?php echo base_url(); ?>gambar/spot/<?php echo $a->spot_sampul ?>" alt="" class="img-fluid">
                  <?php } ?>
                </a>
              </div>
              <div class="card-body">
                <div class="card-category-box">
                  <div class="card-category">
                    <h6 class="category"><?php echo $a->jalur_nama ?></h6>
                  </div>
                </div>

                <h3 class="card-title"><a href="<?php echo base_url().$a->spot_slug ?>"><?php echo $a->spot_judul ?></a></h3>

              </div>
              <div class="card-footer">
                <div class="spott-author">
                  <a href="#">
                    <span class="author"><?php echo $a->pengguna_nama; ?></span>
                  </a>
                </div>
                <div class="spott-date">
                  <span class="ion-ios-clock-outline"></span> <?php echo date('d-M-Y', strtotime($a->spot_tanggal)); ?>
                </div>
              </div>
            </div>
          </div>
